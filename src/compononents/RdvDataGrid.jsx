...
function RdvDataGrid() {
    ...
    const URL = "http://127.0.0.1:8000/rdv"
  ...
  const handleDelete=async(val)=>{
    await axios.delete(URL+"/"+val.RdvId)
    loadVehiculeData()
  }
